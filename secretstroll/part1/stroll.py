...
class Client:
    ...
    def prepare_registration(
        ...
        # create issue req
        if self.measurement_mode:
            issue_req, t = measured(IssueScheme.create_issue_request, measurements["IssueScheme"]["create_issue_request"])(user_attributes=attributes, pk=server_pk, testing=testing, measurements=measurements)
        else:
